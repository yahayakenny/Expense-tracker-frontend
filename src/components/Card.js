            ...
            <div className= "col-md-4">
                <div className="card text-white mb-3 shadow-lg text-center" style={{backgroundColor: "rgb(162, 205, 205)"}}>
                    ...
                    <div className="card-body">
                        ...
                        <br></br><br></br>
                        <h1 className="card-text">{settings.currency ? settings.currency: '£'}{cardData ? commas(cardData.expense) : cardData.expense}</h1>
                    </div>
            ...
            <div className= "col-md-4" >
                <div className="card text-white mb-3 shadow-lg text-center" style = {{backgroundColor: "rgb(213, 126, 126)"}}>
                    ...
                    <div className="card-body">
                        ...
                        <br></br><br></br>
                        <h1 className="card-text">{settings.currency ? settings.currency: '£'}{cardData ? commas(cardData.income) : cardData.income}</h1>
                    </div>
                </div> 
            </div>
