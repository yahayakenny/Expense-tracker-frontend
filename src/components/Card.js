    ...
    return (
        <div className = "row"> 
            <div className= "col-md-4">
                <div className="card card-dashboard text-white mb-3 shadow-lg text-center" style={{backgroundColor: "rgb(162, 205, 205)"}}>
            ...
            <div className= "col-md-4" >
                <div className="card card-dashboard text-white mb-3 shadow-lg text-center" style = {{backgroundColor: "rgb(213, 126, 126)"}}>
            ...
            <div className= "col-md-4 text-center">
                <div className="card card-dashboard text-white mb-3 shadow-lg" style={{backgroundColor: "rgb(198, 213, 126)"}}>
