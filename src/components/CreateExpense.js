                            ...
                            {({values, errors, touched, handleChange, handleBlur, handleSubmit}) => (
                                <form onSubmit = {handleSubmit}>
                                    ...
                                    <div className = "mt-2 mb-4 p-6">
                                        ...
                                        <select style={{width:'100%', height: '38px', borderWidth: 'none', padding: "3px"}} className="form-select" name = "category" id = "category" value={values.category} onChange = {handleChange}> 
